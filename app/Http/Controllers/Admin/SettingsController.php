...
class SettingsController extends MainAdminController
{
    ...
    {   
        ...
        putPermanentEnv('FCM_SERVER_KEY', $inputs['fcm_server_key']);
        putPermanentEnv('FCM_SENDER_ID', $inputs['fcm_sender_id']);

        putPermanentEnv('MAILCHIMP_APIKEY', $inputs['mailchimp_apikey']);
        putPermanentEnv('MAILCHIMP_LIST_ID', $inputs['mailchimp_list_id']);
        ...
        $settings->fcm_server_key = $inputs['fcm_server_key'];
        $settings->fcm_sender_id = $inputs['fcm_sender_id'];

        $settings->mailchimp_apikey = $inputs['mailchimp_apikey'];
        $settings->mailchimp_list_id = $inputs['mailchimp_list_id'];

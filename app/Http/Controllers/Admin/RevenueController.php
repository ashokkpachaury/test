...
class RevenueController extends MainAdminController
{
    ...
    { 
            ...
            $page_title = trans('words.revenue')?trans('words.revenue'):'Revenue';
                
            return view('admin.pages.revenue',compact('page_title','users','language','genres','movies','series','sports','livetv','transactions','daily_amount','weekly_amount','monthly_amount','yearly_amount','plan_list'));

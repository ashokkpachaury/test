...
//use GeoIP;
class DashboardController extends MainModeratorController
{
    ...
    { 
        ...
        return view('moderator.pages.dashboard',compact('page_title','users','language','genres','movies','series','sports','livetv','transactions','daily_amount','weekly_amount','monthly_amount','yearly_amount','plan_list'));
    }

...
class EpisodesController extends MainModeratorController
{
    ...
    { 
        ...
        if(isset($_GET['s']))
        {
            ...
            $episodes_list = DB::table('episodes')
                ...
                ->where("episodes.moderator_id",$moderatorId)
                ->orderBy('id','DESC')
                ->paginate(10);
        ...
        return view('moderator.pages.episodes_list',compact('page_title','episodes_list','series_list'));
    }
    ...
    public function addEpisode()    { 
        ...
        $series_list = Series::orderBy('series_name')->get(); 
        return view('moderator.pages.addeditepisode',compact('page_title','series_list'));
    }
    ...
    {         
        ...
        $episode_obj->status = '0';//$inputs['status'];  
        ...
        $episode_obj->moderator_id = $moderatorId;
    ...
    {     
        ...
        return view('moderator.pages.addeditepisode',compact('page_title','episode_info','series_slug','series_list','season_list'));
    }	 
    ...
    public function ajax_get_season_list($series_id)    {  
        $season_list = Season::where('series_id',$series_id)->orderBy('id','DESC')->get(); 
        return view('moderator.pages.ajax_season_list',compact('season_list'));
    }

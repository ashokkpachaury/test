...
@section('head_image', ($series_info->series_poster))
    ...
    <div class="container">
      <div class="series_episode">
		<div class="upcomming-featured">
		  <img class="img-responsive" src="{{($series_info->series_poster)}}" alt="{{$series_info->series_name}}">
        ...
        <div class="owl-carousel video-carousel" id="video-carousel">
          ...
          <div class="vfx_video_item">
            <div class="thumb-wrap vfx_upcomming_item_block">
              <img src="{{($season_data->season_poster)}}" alt="{{$season_data->season_name}}">
            </div>

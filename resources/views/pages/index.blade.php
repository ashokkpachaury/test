    ...
    <div class="container">
      ...
      <div class="row">
        ...
        @foreach($home_sections_list3 as $list3_data)
            ...
            <div class="vfx_video_item">
			  <div class="vfx_upcomming_item_block">
                <img class="img-responsive" src="{{$list3_data->series_poster)}}" alt="show">
                <div class="vfx_upcomming_detail">
      ...
      <div class="row">
        ...
        <div class="owl-carousel video-carousel vfx_tvshow_carousel" id="vfx_tvshow_carousel">
           ...
           @foreach($home_sections_list3 as $list3_data)
            ...
            @endif
            <div class="vfx_video_item">
              <div class="thumb-wrap"> <img src="{{($list3_data->video_image_thumb)}}" alt="Movie Thumb"> @if($list3_data->video_access=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif
                <div class="thumb-hover">
					<i class="icon fa fa-play"></i><span class="ripple"></span>
				</div>
              </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        @foreach($home_sections_list4 as $list4_data)
            ...
            <div class="vfx_video_item">
              <div class="vfx_upcomming_item_block">
                <img class="img-responsive" src="{{($list4_data->series_poster)}}" alt="show">
              </div>
			  <div class="vfx_upcomming_detail">
        ...
        <div class="owl-carousel video-carousel vfx_tvshow_carousel" id="vfx_tvshow_carousel">
           ...
           @foreach($home_sections_list4 as $list4_data)
            ...
            <div class="vfx_video_item">
              ...
              <div class="thumb-wrap"> <img src="{{($list4_data->video_image_thumb)}}" alt="Movie Thumb"> @if($list4_data->video_access=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif
                <div class="thumb-hover">
            <i class="icon fa fa-play"></i><span class="ripple"></span>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        @foreach($home_sections_list5 as $list5_data)
            ...
            <div class="vfx_video_item">
              <div class="vfx_upcomming_item_block">
             <img class="img-responsive" src="{{($list5_data->series_poster)}}" alt="show">
                <div class="vfx_upcomming_detail">
        ...
        <div class="owl-carousel video-carousel vfx_tvshow_carousel" id="vfx_tvshow_carousel">
           ...
           @foreach($home_sections_list5 as $list5_data)
            ...
            <div class="vfx_video_item">
              ...
              <div class="thumb-wrap"> <img src="{{($list5_data->video_image_thumb)}}" alt="Movie Thumb"> @if($list5_data->video_access=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif
                <div class="thumb-hover">

        ...
        <div class="owl-carousel video-carousel" id="video-carousel">
	      ...
	      @endif
           <div class="vfx_video_item">
              <div class="thumb-wrap"> <img src="{{(.$movies_data->video_image_thumb)}}" alt="Movie Thumb"> @if($movies_data->video_access=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif

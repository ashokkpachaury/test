...
<head>
  ...
  <title>{{trans('words.reset_password').' | '.getcong('site_name')}}</title>
  <!-- App css -->
...
<body>
  ...
  <div class="wrapper-page">
    ...
    <div class="m-t-20 card-box">
      <div class="text-center">
        <h3 class="text-uppercase font-bold m-b-0">{{trans('words.reset_password')}}</h3>
          <div class="message">                                                 
            @if (count($errors) > 0)
      ...
      <div class="p-10">
        {!! Form::open(array('url' => 'password/reset','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'passwordform','role'=>'form')) !!}
            ...
            <div class="form-group">
                <label for="password_confirmation">{{trans('words.confirm_password')}}</label>
                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="{{trans('words.confirm_password')}}">
            </div>
            <div class="form-group">

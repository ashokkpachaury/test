    ...
    <div class="container">
      ...
      <div class="col-md-2 col-sm-4 col-xs-6">
            <div class="vfx_video_item">
              <div class="thumb-wrap"> <img src="{{($movies_data->video_image_thumb)}}" alt="{{$movies_data->video_title}}"> @if($movies_data->video_access=='Paid')<span class="premium_video"><i class="fa fa-lock"></i>Premium</span>@endif

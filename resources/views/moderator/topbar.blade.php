<div class="topbar">
      <div class="topbar-left"> 
        <a href="{{ URL::to('moderator/dashboard') }}" class="logo">
          <span>
            ...
            <ul class="list-unstyled topbar-right-menu float-right mb-0"> 
              <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                  <a href="{{ URL::to('moderator/profile') }}" class="dropdown-item notify-item">
                    <i class="ti-user m-r-5"></i> {{trans('words.profile')}}
                  </a>
                  <a href="{{ URL::to('moderator/logout') }}" class="dropdown-item notify-item">

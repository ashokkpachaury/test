                    ...
                    <div class="block block-themed animated fadeIn">
                        <div class="block-header bg-primary">
                            <ul class="block-options">
                                ...
                                <li>
                                    <a href="{{ URL::to('moderator/') }}" data-toggle="tooltip" data-placement="left" title="Log In"><i class="si si-login"></i></a>
                                </li>
...
<span aria-hidden="true">&times;</span></button>
                        ...
                        @endif
                            ...
                            <!-- For more examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                {!! Form::open(array('url' => 'moderator/password/email','class'=>'js-validation-login form-horizontal push-30-t push-50','id'=>'passwordform','role'=>'form')) !!}

          ...
          <div class="row">
            <div class="col-xl-8">
              <div class="card-box">
                ...
                {!! Form::open(array('url' => 'moderator/profile','class'=>'form-horizontal','name'=>'profile_form','id'=>'profile_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="user_address" value="{{ isset(Auth::user()->user_address) ? Auth::user()->user_address : null }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">

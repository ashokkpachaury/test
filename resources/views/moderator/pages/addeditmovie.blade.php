          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                   ...
                   <div class="row">
                     <div class="col-sm-6">
                          <a href="{{ URL::to('moderator/movies') }}"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> {{trans('words.back')}}</h4></a>
                     </div>
                   </div>
                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('moderator/movies/add_edit_movie'),'class'=>'form-horizontal','name'=>'movie_form','id'=>'movie_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                 ...
                 <div class="row">
                  ...
                  <div class="form-group row" style="display: none;">
                    <input type="text"name="movie_language" id="movie_language" value="2" class="form-control">
                  </div>
                  <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                           ...
                           <img src="{{($movie->video_image_thumb)}}" alt="video thumb" class="img-thumbnail" width="200">
...
<div id="model_movie_thumb" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-body">
               <div class="iframe-container">
               <iframe loading="lazy" src="{{URL::to('responsive_filemanager/filemanager/dialog.php?type=2&sort_by=date&field_id=video_image_thumb&relative_url=1')}}" frameborder="0"></iframe>
               </div>
            </div>
        </div>
    </div>

          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="card-box">
                ...
                <div class="row">
                 <div class="col-sm-6">
                      <a href="{{ URL::to('moderator/season') }}"><h4 class="header-title m-t-0 m-b-30 text-primary pull-left" style="font-size: 20px;"><i class="fa fa-arrow-left"></i> {{trans('words.back')}}</h4></a>
                 </div>
               </div>
                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('moderator/season/add_edit_season'),'class'=>'form-horizontal','name'=>'season_form','id'=>'season_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                           ...
                           <img src="{{($season_info->season_poster)}}" alt="video image" class="img-thumbnail" width="250">
    ...
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-body">
               ...
               <iframe loading="lazy" src="{{URL::to('responsive_filemanager/filemanager/dialog.php?type=2&sort_by=date&field_id=season_poster&relative_url=1')}}" frameborder="0"></iframe>
               </div>
            </div>
        </div>
    </div>

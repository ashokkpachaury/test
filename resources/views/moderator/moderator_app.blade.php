  ...
  <script type="text/javascript">
    $(document).ready(function(e) { 
      $("#episode_series_id").change(function(){
        ...
        $.ajax({
        type: "GET",
        url: "{{ URL::to('moderator/ajax_get_season') }}/"+series_id,
        //data: "cat=" + cat,
    ...
    jQuery(document).ready(function(){
        $(document).on('click', '#import_movie_btn', function() {
            ...
            if (from != '' && id != '') {
                $.ajax({
                    type: 'GET',
                    url: "{{ URL::to('moderator/find_imdb_movie') }}",
    ...
    jQuery(document).ready(function(){
        $(document).on('click', '#import_show_btn', function() {
            ...
            if (from != '' && id != '') {
                $.ajax({
                    type: 'GET',
                    url: "{{ URL::to('moderator/find_imdb_show') }}",
                    data: "id=" + encodeURIComponent(id) + "&from=" + encodeURIComponent(from),
                    dataType: 'json',
                    beforeSend: function() {
    ...
    jQuery(document).ready(function(){
        $(document).on('click', '#import_episode_btn', function() { 
            ...
            if (from != '' && id != '') {
                $.ajax({
                    type: 'GET',
                    url: "{{ URL::to('moderator/find_imdb_episode') }}",
                    data: "id=" + encodeURIComponent(id) + "&from=" + encodeURIComponent(from),
                    dataType: 'json',
                    beforeSend: function() {

    ...
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-body">
               ...
               <iframe loading="lazy" src="{{URL::to('responsive_filemanager/filemanager/dialog.php?type=2&sort_by=date&field_id=language_image&relative_url=1')}}" frameborder="0"></iframe>
               </div>
            </div>
        </div>
    </div>

...
<style type="text/css">
    ...
    /* CSS to display buttons side by side */
    .form-group .btn {
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card-box">
                        ...
                        <input type="hidden" name="platform" value="{{ isset($platform) ? $platform : null }}">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">{{trans('words.productId')}}*</label>
                            <div class="col-sm-8">
                                <input type="text" name="productId" value="{{ isset($plan_info->productId) ? $plan_info->productId : null }}" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" name="plan_duration" value="{{ isset($plan_info->plan_duration) ? $plan_info->plan_duration : null }}" class="form-control" placeholder="Write here">
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">{{trans('words.price')}}* <br />
                                <!-- <small id="emailHelp" class="form-text text-muted">The minimum amount for processing a transaction through Stripe in USD is $0.50. For more info <a href="https://support.chargebee.com/support/solutions/articles/228511-transaction-amount-limit-in-stripe" target="_blank">click here</a>-->
                                </small></label>
                            <div class="col-sm-8">
                                <input type="text" name="plan_price" value="{{ isset($plan_info->plan_price) ? $plan_info->plan_price : null }}" class="form-control" placeholder="Write here">
                            </div>
                        </div>
                        ...
                        <!-- Save and Cancel buttons in line -->
                        <div class="form-group">
                            <div class="offset-sm-3 col-sm-9">
                                <button type="submit" class="btn btn-primary waves-effect waves-light">{{ trans('words.save') }}</button>
                                <button type="button" class="btn btn-secondary waves-effect waves-light" onclick="goBack()">{{ trans('words.cancel') }}</button>
                            </div>
                        </div>

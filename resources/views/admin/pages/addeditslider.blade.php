...
{{--                                <option value="Sports" @if(isset($slider_info->id) && $slider_info->slider_type=="Sports") selected @endif>{{trans('words.sports_text')}}</option>--}}
                  ...
                  <div class="form-group row" id="show_list_id" @if(isset($slider_info->id) && $slider_info->slider_type!="Series" && $slider_info->slider_type!="Shows") style="display: none;" @endif @if(!isset($slider_info->id)) style="display: none;" @endif>
                    <label class="col-sm-3 col-form-label">{{trans('words.tv_shows_text')}}</label>
                      <div class="col-sm-8">
                            <select class="form-control select2" name="series_id" id="series_id">
                                ...
                                <option value="{{$series_data->id}}" @if(isset($slider_info->id) && ($slider_info->slider_type=="Series" || $slider_info->slider_type=="Shows") && $slider_info->slider_post_id==$series_data->id) selected @endif>{{$series_data->series_name}}</option>
                                @endforeach
                            </select>
                      </div>
                  </div>
    ...
    <div class="modal-dialog modal-lg" style="max-width: 900px;">
        <div class="modal-content">
            <div class="modal-body">
               ...
               <iframe loading="lazy" src="{{URL::to('responsive_filemanager/filemanager/dialog.php?type=2&sort_by=date&field_id=slider_image&relative_url=1')}}" frameborder="0"></iframe>
               </div>
            </div>
        </div>
    </div>

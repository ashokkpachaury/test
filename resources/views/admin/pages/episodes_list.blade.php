                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                   @foreach($episodes_list as $i => $episodes)
                       <?php
                       $poster_ur = LrFileUrl($episodes->video_image ? $episodes->video_image : $episodes->imageUrl);

                    ?>
                           <tr>
                      <td>{{ $episodes->series_name }}</td>
                      <td>{{ stripslashes($episodes->video_title) }}</td>
                      <td>@if(isset($poster_ur)) <img src="{{($poster_ur)}}" alt="video image" class="thumb-lg bdr_radius"> @endif</td>

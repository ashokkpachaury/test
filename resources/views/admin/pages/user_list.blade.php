          ...
          <div class="row">
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="col-md-3">
                  <a href="{{URL::to('admin/users/add_user')}}" class="btn btn-success btn-md waves-effect waves-light m-b-20" data-toggle="tooltip" title="{{trans('words.add_user')}}"><i class="fa fa-plus"></i> {{trans('words.add_user')}}</a>
                </div>
                <div class="col-md-3">
                  ...
                  <tbody>
                   @foreach($user_list as $i => $user_data)
                    <tr>
                      ...
                      <td>
                      <a href="{{ url('admin/users/subprofiles/'.$user_data->id) }}" class="btn btn-icon waves-effect waves-light btn-info m-b-5 m-r-5" data-toggle="tooltip" title="{{trans('words.sub_profiles')}}"> <i class="fa fa-users"></i> </a>

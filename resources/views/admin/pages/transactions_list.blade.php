            ...
            <div class="col-12">
              <div class="card-box table-responsive">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                     <select class="form-control" name="transactions_select" id="transactions_select">
                        <option value="">{{trans('words.filter_by_transactions')}}</option>
                        <option value="?transactions=daily-transactions" @if(isset($_GET['transactions']) && $_GET['transactions']=='daily-transactions' ) selected @endif>Daily transactions</option>
                        <option value="?transactions=daily-cancellations" @if(isset($_GET['transactions']) && $_GET['transactions']=='daily-cancellations' ) selected @endif>Daily cancellations</option>
                    </select>
                  </div> 
                  <div class="col-md-3">

              ...
              <div class="card-box">
                ...
                @endif
                 ...
                 {!! Form::open(array('url' => array('admin/episodes/add_edit_episode'),'class'=>'form-horizontal','name'=>'episode_form','id'=>'episode_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                  ...
                  <!-- Adding Episode Number 09 Nov 2023-->
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label">{{trans('words.episode_number')}}*</label>
                    <div class="col-sm-8">
                      <input type="number" name="episode_number" id="episode_number" value="{{ isset($episode_info->episode_number) ? stripslashes($episode_info->episode_number) : 1 }}" class="form-control">
                    </div>
                  </div>
                  <div class="form-group row">

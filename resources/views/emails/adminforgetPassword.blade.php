...
If this was you, you can set a new password by clicking the link below:
 ...
 <tr>
  <td style="text-align:center; margin:10px auto;float:left;width:100%;line-height:48px;">
   <a href="{{ url('resetPassword/'.$token) }}" style="font-size: 15px;margin-bottom:10px;text-align: center;background: #007ee6;color: #fff;border-radius: 6px;text-decoration:none;padding:15px 30px;">Reset Password</a>
  </td>
 </tr>
 <tr>
